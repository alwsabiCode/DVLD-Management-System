...
namespace DVLD_System.Tests.Test_Types
{
    public partial class frmListTestType : Form
    {
        ...
        {
            _ListTestTypes = clsTestTypes.GetAllTestTyepe();
            dgvTestTypes.DataSource = _ListTestTypes;
            lblRecordCount.Text = dgvTestTypes.Rows.Count.ToString();
        ...
        {
            frmEditTestType frm= new frmEditTestType((clsTestTypes.enTestType)dgvTestTypes.CurrentRow.Cells[0].Value);
            frm.ShowDialog();
