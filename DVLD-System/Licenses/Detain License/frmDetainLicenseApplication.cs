...
namespace DVLD_System.Licenses.Detain_License
{
    public partial class frmDetainLicenseApplication : Form
    {
        ...
        {
            tcDetainLicense.SelectedTab = tcDetainLicense.TabPages["tpDetainInfo"];
        }
        ...
        private void btnDetain_Click(object sender, EventArgs e)
        {
            ...
            _DetainID = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.Detain(Convert.ToDecimal(txtFineFees.Text), clsGlobal.CurrentUser.UserDTO.UserID);
            if (_DetainID == -1)
            {
